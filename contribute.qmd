...
*The advantage to using R and RStudio is the ability to toggle between Source and Visual representation of the page*

*The advantage of VsCode is...*
...
5.  **Install Github Desktop (optional)**
    ...
    [Github desktop](https://desktop.github.com/download/) is a GUI that makes using Git easier for beginners. Other methods of using Git also work.
