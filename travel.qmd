...
The Division has several vehicles available for field work. Please see [DWR Employee Resources Fleet Page](https://cawaterboards.sharepoint.com/DWR/ER/SitePages/Fleet.aspx) for up-to-date information about using fleet vehicles.

## Quick links

-   [Travel Pocket Guide (Intranet)](https://waternet.waterboards.ca.gov/das/accounting/docs/2023/travel-pocket-guide-september-2023.pdf) - can only access on VPN 
